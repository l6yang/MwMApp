...
public class PersonalHandler extends BaseClickHandler<ActivityPersonalBinding> {
    ...
    private void selectImage() {
        ...
        // Album.startAlbum(this, IntImpl.reqCode_Main_UCrop, 9);

        // 2. 使用默认风格，不指定选择数量：
        // Album.startAlbum(this, IntImpl.reqCode_Main_UCrop); // 第三个参数不填的话，可以选择无数个。

        // 3. 指定风格，并指定选择数量，如果不想限制数量传入Integer.MAX_VALUE;
        Album.startAlbum(activity, IntImpl.reqCode_Main_UCrop, 1                                                         // 指定选择数量。
