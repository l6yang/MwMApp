...
public class VoiceUtil {
    ...
    private void initSpeechSynthesizer(Context context) {
        ...
        mSpeechSynthesizer.setAppId(Contact.Str.appId/*这里只是为了让Demo运行使用的APPID,请替换成自己的id。*/);
        // 请替换为语音开发者平台注册应用得到的apikey和secretkey (在线授权)
        mSpeechSynthesizer.setApiKey(Contact.Str.appKey,
                Contact.Str.secretKey/*这里只是为了让Demo正常运行使用APIKey,请替换成自己的APIKey*/);
